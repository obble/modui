    ...
    menu.intro:SetText'Hello! You are using version v64 of |cffff6c6cmodui|r. You can find the latest version and further support on the dedicated thread on Nostalrius\' forums:'
