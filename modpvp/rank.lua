     ...
     local p = (math.floor(GetPVPRankProgress(target)*10000))/100
     local r = UnitPVPRank'player'
     local c = (r - 6)*5000 + 5000*p/100
     local n = (r - 5)*5000 - c*.8
     ...
     local modtip = function()
         ...
         GameTooltip:AddLine' '
         GameTooltip:AddLine('These totals give a projection of how many rank points you require to reach a new rank at the end of the week. Honour rankings are fluid & dependent on total RP earned across the server — therefore results may vary.', 1, .8, 0, true)
         GameTooltip:AddLine' '
